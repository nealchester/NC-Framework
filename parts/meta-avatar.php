...
<div class="postmeta">
	<div class="postmeta_container">
		...
		<div class="postmeta_content">
			<div class="postmeta_name" itemprop="author" itemscope="" itemtype="http://schema.org/Person">By <a itemprop="name" rel="author" href="<?php echo esc_url($authorlink) ?>"><?php the_author(); ?></a></div> 
