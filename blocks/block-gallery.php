		  ...
		  <?php nc_before_content(); ?>
			...
			?>
				...
				<figure class="ncgallery_item">
					<?php if($link2img == 'image_page'):?><a class="ncgallery_link" href="<?php echo get_attachment_link($image['ID']); ?>">
					<?php elseif($link2img == 'image_lightbox'):?><a data-title="<?php echo $image['title']; ?>" class="ncgallery_link <?php echo'ncgimg_'.$id; ?>" href="<?php echo wp_get_attachment_image_url($image['ID'], 'large'); ?>"><?php endif;?>
